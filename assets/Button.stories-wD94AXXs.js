...
}`,...D.parameters?.docs?.source}}};const G=["Primary","Destructive","Outline","Ghost","SecondaryColor","TertiaryGrey","Small","Medium","Large","IconLeft","IconRight","IconAlone","FullWidth","FullWidthWithIcon","FullWidthTypes","Disabled","DestructiveDisabled","OutlineDisabled","AllTypes","AllSizes","AllIconPositions","AllHovered","AllFocused","AllDisabled"],_=Object.freeze(Object.defineProperty({__proto__:null,AllDisabled:D,AllFocused:A,AllHovered:j,AllIconPositions:S,AllSizes:F,AllTypes:B,Destructive:n,DestructiveDisabled:x,Disabled:b,FullWidth:g,FullWidthTypes:v,FullWidthWithIcon:h,Ghost:o,IconAlone:y,IconLeft:p,IconRight:m,Large:u,Medium:d,Outline:s,OutlineDisabled:f,Primary:t,SecondaryColor:i,Small:c,TertiaryGrey:l,__namedExportsOrder:G,default:O},Symbol.toStringTag,{value:"Module"}));export{B as A,_ as B,n as D,g as F,o as G,s as O,t as P,i as S,l as T,F as a,S as b,h as c,v as d,D as e};
